  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="order in UserTrade.detailArrayList"
          :key="order.id"
        >
          <li>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{
          userDefaultAddress ? userDefaultAddress.fullAddress : ""
        }}</span>
        收货人：<span>{{
          userDefaultAddress ? userDefaultAddress.consignee : ""
        }}</span>
        <span>{{ userDefaultAddress ? userDefaultAddress.phoneNum : "" }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["UserAddressList", "UserTrade"]),
    // 将来提交用的最终地址
    userDefaultAddress() {
